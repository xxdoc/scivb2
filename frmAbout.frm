...
Private Sub Form_Load()
  ...
  str = str & vbCrLf & vbCrLf & "SCIVB is an easy to use wrapper VB ActiveX control for Scintilla, " & _
        "an excellent opensource component available at http://www.scintilla.org which provides " & _
        "high quality syntax highlighting, code folding, code tips, code hints, and more."
